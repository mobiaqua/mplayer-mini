...
CC_DEPFLAGS = -MMD -MP
EXTRALIBS =  -Wl,-z,noexecstack -Wl,-O1 -Wl,--hash-style=gnu -Wl,--as-needed -lncurses -lrt -lasound -lfreetype -lz -lfontconfig -lpthread -ldl -lm -lmpg123 -ldce -ldrm -ldrm_omap -lgbm -lEGL -lGLESv2 -lavfilter -lavformat -lavcodec -lswscale -lswresample -lavutil
